...
import { DEFAULT_VOICE_1, DEFAULT_VOICE_2, DEFAULT_AGENT_1_NAME, DEFAULT_AGENT_2_NAME } from "../src/lib/config";
...
const SCENARIOS = [
  {
    ...
    description:
      "A sales rep pitches an AI workflow platform to a skeptical VP of Ops.",
    builtIn: true,
    agents: [
      {
  ...
  },
  {
    ...
    description:
      "A support agent handles a frustrated customer call about a billing issue.",
    builtIn: true,
    agents: [
      {
        name: DEFAULT_AGENT_1_NAME,
      ...
      },
      {
        ...
        goes_first: false,
        prompt:
          "You are {{ name }}, a customer of {{company}}. You are calling about {{topic}}.\n\n{{issue_description}}",
        rules:
  ...
  },
  {
    ...
    description:
      "An account executive runs a discovery call to understand a prospect's needs.",
    builtIn: true,
    agents: [
      {
        name: DEFAULT_AGENT_1_NAME,
